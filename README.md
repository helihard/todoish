Todoish är en app jag byggt som ett privat projekt för att öva på React och HTML request methods. Appen använder sig av samtliga CRUD-metoder mot ett fejk-API (lokal JSON-fil):
